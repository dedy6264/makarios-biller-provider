<x-app-layout>
{{-- @extends('layoutsviller.app')
@section('content') --}}
@section('title', 'Dashboard Viller')
    <div class="row">
      ...
      <div class="mt-4 row">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <a class="mt-auto mb-0 text-sm text-body font-weight-bold icon-move-right" href="javascript:;">
                      Read More
                ...
                <div class="mt-5 text-center col-lg-5 ms-auto mt-lg-0">
                  <div class="bg-gradient-primary border-radius-lg h-100">
                    <img src="../assets/img/shapes/waves-white.svg" class="top-0 position-absolute h-100 w-50 d-lg-block d-none" alt="waves">
                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                      <img class="pt-4 w-100 position-relative z-index-2" src="../assets/img/illustrations/rocket-white.png" alt="rocket">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-5">
          <div class="p-3 card h-100">
            <div class="overflow-hidden bg-cover position-relative border-radius-lg h-100" style="background-image: url('../assets/img/ivancik.jpg');">
              ...
              <div class="p-3 card-body position-relative z-index-1 d-flex flex-column h-100">
                ...
                <a class="mt-auto mb-0 text-sm text-white font-weight-bold icon-move-right" href="javascript:;">
                  Read More
                  <i class="text-sm fas fa-arrow-right ms-1" aria-hidden="true"></i>
                </a>
              </div>
                ...
                <div class="row">
                  <div class="py-3 col-3 ps-0">
                    <div class="mb-2 d-flex">
                      <div class="text-center shadow icon icon-shape icon-xxs border-radius-sm bg-gradient-primary me-2 d-flex align-items-center justify-content-center">
                  ...
                  <div class="py-3 col-3 ps-0">
                    <div class="mb-2 d-flex">
                      <div class="text-center shadow icon icon-shape icon-xxs border-radius-sm bg-gradient-info me-2 d-flex align-items-center justify-content-center">
                  ...
                  <div class="py-3 col-3 ps-0">
                    <div class="mb-2 d-flex">
                      <div class="text-center shadow icon icon-shape icon-xxs border-radius-sm bg-gradient-warning me-2 d-flex align-items-center justify-content-center">
                  ...
                  <div class="py-3 col-3 ps-0">
                    <div class="mb-2 d-flex">
                      <div class="text-center shadow icon icon-shape icon-xxs border-radius-sm bg-gradient-danger me-2 d-flex align-items-center justify-content-center">
                        <svg width="10px" height="10px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    @push('scripts')
      <script src="{{url('/assets/js/plugins/chartjs.min.js')}}"></script><!--grafik -->
      <script src="{{url('/assets/js/grafik.js')}}"></script><!-- Grafik -->
      <script>
