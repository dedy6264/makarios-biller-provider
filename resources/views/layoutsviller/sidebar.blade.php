<aside class="my-3 border-0 sidenav navbar navbar-vertical navbar-expand-xs border-radius-xl fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="m-0 navbar-brand" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Makarios Dashboard</span>
      </a>
    </div>
    @yield('activeMenu')
...
{{-- @dd(session('role_code')) --}}
      @if(session('role_id')==1)
        ...
        <li class="nav-item">
          <a class="nav-link {{Route::is('user_roles.index')  ? 'active':''}}" href="{{ route('user_roles.index') }}">
            <div class="text-center bg-white shadow icon icon-shape icon-sm border-radius-md me-2 d-flex align-items-center justify-content-center">
      ...
      @endif
        <li class="nav-item">
          ...
          <div class="collapse {{Route::is(['clients.index', 'merchants.index','groups.index']) ?  'show':''}}" id="dropdownPartner" style="">
            ...
            @endif
              ...
              <li class="nav-item {{Route::is('merchants.index') ?  'active':''}}">
                <a class="nav-link " href="{{ route('merchants.index') }}">
                  <span class="sidenav-mini-icon"> O </span>
                  <span class="sidenav-normal"> Merchant </span>
                </a>
              </li>
            </ul>
          </div>
         ...
         <li class="nav-item">
          ...
          <div class="collapse {{Route::is(['segments.index', 'product_segments.index','products.index','product_types.index','product_categories.index','product_references.index','providers.index','product_providers.index','transactions.index']) ?  'show':''}}" id="dropdownProduct" style="">
            <ul class="nav ms-4 ps-3">
              ...
              <li class="nav-item {{Route::is('product_references.index') ?  'active':''}}">
                <a class="nav-link " href="{{ route('product_references.index') }}">
                  <span class="sidenav-mini-icon"> R </span>
              ...
              <li class="nav-item {{Route::is('providers.index') ?  'active':''}}">
                <a class="nav-link " href="{{ route('providers.index') }}">
                  <span class="sidenav-mini-icon"> R </span>
                  <span class="sidenav-normal"> Provider </span>
                </a>
              </li>
              <li class="nav-item {{Route::is('product_providers.index') ?  'active':''}}">
                <a class="nav-link " href="{{ route('product_providers.index') }}">
                  <span class="sidenav-mini-icon"> R </span>
                  <span class="sidenav-normal"> Product Provider </span>
                </a>
              </li>
              <li class="nav-item {{Route::is('segments.index') ?  'active':''}}">
                <a class="nav-link " href="{{ route('segments.index') }}">
                  <span class="sidenav-mini-icon"> O </span>
                  <span class="sidenav-normal"> Segment </span>
                </a>
              </li>
              <li class="nav-item {{Route::is('product_segments.index') ?  'active':''}}">
                <a class="nav-link " href="{{ route('product_segments.index') }}">
                  <span class="sidenav-mini-icon"> O </span>
                  <span class="sidenav-normal">Product Segment </span>
                </a>
              </li>
              @endif
        ...
        <li class="nav-item">
          ...
          <div class="collapse {{Route::is(['accounts.index', 'savings.index','saving_transactions.index']) ?  'show':''}}" id="dropdownAccount" style="">
            <ul class="nav ms-4 ps-3">
              ...
              <li class="nav-item {{Route::is('savings.index') ?  'active':''}}">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{ route('mini_app.index') }}">
            <div class="text-center bg-white shadow icon icon-shape icon-sm border-radius-md me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Mini App</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <div class="mx-3 sidenav-footer ">
      ...
      <a class="mt-4 btn bg-gradient-primary w-100" href="https://www.creative-tim.com/product/soft-ui-dashboard-pro?ref=sidebarfree" type="button">Upgrade to pro</a>
    </div>
  </aside>