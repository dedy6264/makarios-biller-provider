<!-- Modal Pulsa Prabayar -->
  <div class="modal fade" id="modalPlnToken" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">PLN Token</h5>
        </div>
        <div class="modal-body">
          <div class="card-body">
            <form role="form text-left">
              <div class="mb-3">
                {{-- <label for="product_code" class="form-label">Client Name</label> --}}
              ...
              <div class="row">
                <div class="pt-3 pb-4 text-center col-lg-2 col-4">
                  <div class="text-center shadow icon icon-shape bg-gradient-primary border-radius-md">
                   ...
                   <div class="pt-1 numbers">
                    <p class="mb-0 text-sm text-capitalize font-weight-bold">20.000</p>
                ...
                <div class="pt-3 pb-4 text-center col-lg-2 col-4">
                  <div class="text-center shadow icon icon-shape bg-gradient-primary border-radius-md">
                   ...
                   <div class="pt-1 numbers">
                    <p class="mb-0 text-sm text-capitalize font-weight-bold">50.000</p>
                    {{-- <h5 class="mb-0 font-weight-bolder"> $53,000 <span class="text-sm text-success font-weight-bolder">+55%</span></h5> --}}
                  </div>
                </div>
              </div>
