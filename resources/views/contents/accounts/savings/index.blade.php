            ...
            <div class="row">
              ...
              <div class="col-6 text-end">
                <a class="mb-0 btn bg-gradient-dark" href="javascript:;" @click="openModal"
                  style="margin-right: 1rem"><i class=" fas fa-plus"></i>&nbsp;&nbsp;Add New </a>
              </div>
            </div>
          </div>
              ...
              <table id="tabeldata" class="mdl-data-table">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Account Name
                    </th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Account Number
                    </th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Account Balance
                    </th>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">@{{ isEditMode ? 'Edit Saving' : 'Add Saving' }}</h5>
          </div>
            ...
            <div class="card-body">
              <form role="form text-left">
                ...
                <div class="mb-3" v-else>
                  ...
                  <select name="account_id" id="account_id" v-model="form.account_id" class="form-select">
      ...
      createApp({
        setup() {
          ...
          const storeSaving=()=>{
            nextTick(()=>{
                // Create new client
               axios.post('{{ route('savings.store') }}', form.value)
                  .then(response => {
