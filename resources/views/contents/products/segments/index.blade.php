              ...
              <table id="tabeldata" class="mdl-data-table">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Segment Name
                    </th>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                {{-- <div class="row"> --}}
                  {{-- <div class="col-lg-6"> --}}
                    <div class="mb-3">
                      ...
                      <input type="text" v-model="form.segment_name" class="form-control" id="segment_name"
                        placeholder="Segment Name" aria-label="Segment Name" aria-describedby="email-addon" autofocus>
                    </div>
                    {{--
                  </div> --}}
                  {{-- </div> --}}
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="isEditMode ? updateSegment() : storeSegment()">Save
              changes</button>
          </div>
        </div>
      </div>
