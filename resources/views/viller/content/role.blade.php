...
<div class="flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
    <div>
        ...
        <p class="font-body-md text-body-md text-on-surface-variant">Kelola tingkat akses dan izin fungsional untuk pengguna sistem.</p>
    </div>
...
<div class="grid items-start grid-cols-12 gap-card-gap">
    <div class="flex flex-col col-span-12 gap-4 md:col-span-4">
        <div class="flex items-center gap-3 p-4 bg-white border rounded-[24px] border-outline-variant shadow-[0px_4px_20px_rgba(0,0,0,0.03)]">
    ...
    <div class="col-span-12 md:col-span-8 bg-white rounded-[24px] border border-outline-variant shadow-[0px_4px_20px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col min-h-[620px]">
        <div class="flex flex-col gap-4 p-6 border-b md:flex-row md:items-center md:justify-between border-outline-variant bg-surface-bright">
            <div>
                <h3 id="detail-title" class="mb-1 font-headline-lg text-headline-lg text-on-surface">Daftar Peran</h3>
                <p id="detail-subtitle" class="font-body-sm text-body-sm text-on-surface-variant">Pilih salah satu peran untuk melihat detailnya.</p>
            </div>
        ...
        <div id="selected-summary" class="grid grid-cols-1 gap-3 px-6 py-5 border-b sm:grid-cols-3 border-outline-variant bg-surface-container-low/40">
            <div>
        ...
        <div class="flex-1 overflow-auto">
            <table id="roles-table" class="w-full text-left border-collapse">
                <thead>
                    <tr>
                        <th class="px-6 py-4 border-b font-label-caps text-label-caps text-on-surface-variant border-outline-variant">NO</th>
                        <th class="px-6 py-4 border-b font-label-caps text-label-caps text-on-surface-variant border-outline-variant">ROLE NAME</th>
                        <th class="px-6 py-4 border-b font-label-caps text-label-caps text-on-surface-variant border-outline-variant">ROLE CODE</th>
                        <th class="px-6 py-4 border-b font-label-caps text-label-caps text-on-surface-variant border-outline-variant">DIBUAT</th>
                        <th class="px-6 py-4 text-center border-b font-label-caps text-label-caps text-on-surface-variant border-outline-variant">AKSI</th>
                    </tr>
                </thead>
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-outline-variant/50 bg-white/60">
                <div class="flex items-center gap-3">
                    <div class="flex items-center justify-center w-9 h-9 rounded-xl bg-primary/10 text-primary">
                        <span id="modal-icon" class="material-symbols-outlined text-[20px]">admin_panel_settings</span>
                    </div>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-[20px] text-on-surface-variant">badge</span>
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-[20px] text-on-surface-variant">key</span>
    ...
    <div class="absolute inset-0 flex items-center justify-center p-4">
        <div class="w-full max-w-[420px] rounded-[24px] shadow-[0px_10px_40px_rgba(0,0,0,0.12)] border border-outline-variant overflow-hidden flex flex-col bg-white">
            <div class="p-6 text-center">
                ...
                <p id="delete-confirm-text" class="font-body-md text-body-md text-on-surface-variant">Tindakan ini tidak dapat dibatalkan.</p>
            </div>
            ...
            tbody.innerHTML = pageData.map((role, idx) => {
                ...
                return `
                    <tr class="table-row-hover border-b border-surface-container ${active ? 'bg-primary/5' : ''}">
                        ...
                        <td class="px-6 py-4 font-data-tabular text-data-tabular text-on-surface font-semibold">${roleName}</td>
